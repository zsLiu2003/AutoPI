...
def test_api():
    ...
    provider = get_llm_provider("claude-sonnet-4-20250514-thinking", "test")
    ...
    user_prompt = "Please help me to generate a new tool des which is a system inilization tool."
