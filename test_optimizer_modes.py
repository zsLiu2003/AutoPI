...
def test_optimizer_modes():
    ...
    # 2. 测试 user-agnostic 优化
    print("\n2. 测试 user-agnostic 优化模式")
    try:
        optimizer_method = optimizer.optimize_user_agnostic
        print(f"   ✓ optimize_user_agnostic 方法存在: {callable(optimizer_method)}")
